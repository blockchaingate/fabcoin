...
#ifndef FABCOIN_QT_WALLETFRAME_H
#define FABCOIN_QT_WALLETFRAME_H
 ...
 * controls into FabcoinGUI. The purpose of this class is to allow future
 * refinements of the wallet controls with minimal need for further
 * modifications to FabcoinGUI, thus greatly simplifying merges while
...
public:
    explicit WalletFrame(const PlatformStyle *platformStyle, FabcoinGUI *_gui = 0);
    ~WalletFrame();
...
#endif // FABCOIN_QT_WALLETFRAME_H
