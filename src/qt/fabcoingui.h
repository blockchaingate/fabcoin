...
#ifndef FABCOIN_QT_FABCOINGUI_H
...
/**
  Fabcoin GUI main class. This class represents the main window of the Fabcoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class FabcoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit FabcoinGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~FabcoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a fabcoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
