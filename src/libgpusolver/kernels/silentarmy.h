const unsigned char CL_MINER_KERNEL[] = R"_mrb_(
# 1 "input.cl"
# 1 "<built-in>"
# 1 "<command-line>"
 ...
 __global uint *rowCountersDst)
{
    ...
    __global char *p;
    uint cnt;
    __local uchar *first_words = &first_words_data[((( 1 << (((200 / (9 + 1)) + 1) - 20)) * 9)+2)*tlid];
    uchar mask;
    uint i, j;
...
# 660 "input.cl"
    ...
    *collisionsNum = 0;
    ...
    for (i = 0; i < cnt-1 && thCollNum < ((( 1 << (((200 / (9 + 1)) + 1) - 20)) * 9) * 5); i++)
    {
...
part2:
    ...
    for (uint index = tlid; index < totalCollisions; index += get_local_size(0))
    {
        ...
        __global uchar *ptr = (__global uchar *)ht_src + collisionThreadId * (( 1 << (((200 / (9 + 1)) + 1) - 20)) * 9) * 32 +
            xi_offset;
...
# 782 "input.cl"
__kernel __attribute__((reqd_work_group_size(64, 1, 1))) void kernel_round1(__global char *ht_src, __global char *ht_dst, __global uint *rowCountersSrc, __global uint *rowCountersDst, __global uint *debug) { __local uchar first_words_data[((( 1 << (((200 / (9 + 1)) + 1) - 20)) * 9)+2)*64]; __local uint collisionsData[((( 1 << (((200 / (9 + 1)) + 1) - 20)) * 9) * 5) * 64]; __local uint collisionsNum; equihash_round(1, ht_src, ht_dst, debug, first_words_data, collisionsData, &collisionsNum, rowCountersSrc, rowCountersDst); }
__kernel __attribute__((reqd_work_group_size(64, 1, 1))) void kernel_round2(__global char *ht_src, __global char *ht_dst, __global uint *rowCountersSrc, __global uint *rowCountersDst, __global uint *debug) { __local uchar first_words_data[((( 1 << (((200 / (9 + 1)) + 1) - 20)) * 9)+2)*64]; __local uint collisionsData[((( 1 << (((200 / (9 + 1)) + 1) - 20)) * 9) * 5) * 64]; __local uint collisionsNum; equihash_round(2, ht_src, ht_dst, debug, first_words_data, collisionsData, &collisionsNum, rowCountersSrc, rowCountersDst); }
__kernel __attribute__((reqd_work_group_size(64, 1, 1))) void kernel_round3(__global char *ht_src, __global char *ht_dst, __global uint *rowCountersSrc, __global uint *rowCountersDst, __global uint *debug) { __local uchar first_words_data[((( 1 << (((200 / (9 + 1)) + 1) - 20)) * 9)+2)*64]; __local uint collisionsData[((( 1 << (((200 / (9 + 1)) + 1) - 20)) * 9) * 5) * 64]; __local uint collisionsNum; equihash_round(3, ht_src, ht_dst, debug, first_words_data, collisionsData, &collisionsNum, rowCountersSrc, rowCountersDst); }
__kernel __attribute__((reqd_work_group_size(64, 1, 1))) void kernel_round4(__global char *ht_src, __global char *ht_dst, __global uint *rowCountersSrc, __global uint *rowCountersDst, __global uint *debug) { __local uchar first_words_data[((( 1 << (((200 / (9 + 1)) + 1) - 20)) * 9)+2)*64]; __local uint collisionsData[((( 1 << (((200 / (9 + 1)) + 1) - 20)) * 9) * 5) * 64]; __local uint collisionsNum; equihash_round(4, ht_src, ht_dst, debug, first_words_data, collisionsData, &collisionsNum, rowCountersSrc, rowCountersDst); }
__kernel __attribute__((reqd_work_group_size(64, 1, 1))) void kernel_round5(__global char *ht_src, __global char *ht_dst, __global uint *rowCountersSrc, __global uint *rowCountersDst, __global uint *debug) { __local uchar first_words_data[((( 1 << (((200 / (9 + 1)) + 1) - 20)) * 9)+2)*64]; __local uint collisionsData[((( 1 << (((200 / (9 + 1)) + 1) - 20)) * 9) * 5) * 64]; __local uint collisionsNum; equihash_round(5, ht_src, ht_dst, debug, first_words_data, collisionsData, &collisionsNum, rowCountersSrc, rowCountersDst); }
__kernel __attribute__((reqd_work_group_size(64, 1, 1))) void kernel_round6(__global char *ht_src, __global char *ht_dst, __global uint *rowCountersSrc, __global uint *rowCountersDst, __global uint *debug) { __local uchar first_words_data[((( 1 << (((200 / (9 + 1)) + 1) - 20)) * 9)+2)*64]; __local uint collisionsData[((( 1 << (((200 / (9 + 1)) + 1) - 20)) * 9) * 5) * 64]; __local uint collisionsNum; equihash_round(6, ht_src, ht_dst, debug, first_words_data, collisionsData, &collisionsNum, rowCountersSrc, rowCountersDst); }
...
{
    uint tid = get_global_id(0);
    __local uchar first_words_data[((( 1 << (((200 / (9 + 1)) + 1) - 20)) * 9)+2)*64];
    __local uint collisionsData[((( 1 << (((200 / (9 + 1)) + 1) - 20)) * 9) * 5) * 64];
    __local uint collisionsNum;
...
const size_t CL_MINER_KERNEL_SIZE = strlen((char *)CL_MINER_KERNEL);
