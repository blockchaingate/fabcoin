...
std::unique_ptr<CBlockTemplate> BlockAssembler::CreateNewBlock(const CScript& scriptPubKeyIn, int64_t* pTotalFees, int32_t txProofTime, int32_t nTimeLimit)
{
    ...
    //jyan addPackageTxs(minGasPrice);
