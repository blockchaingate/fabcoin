Fabcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/fabcoin/files/Fabcoin/fabcoin-0.5.4/
...
http://gitorious.org/fabcoin/fabcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Fabcoin-Qt notifications under Growl 1.3.
Increase required age of Fabcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxFabcoin properly when installing Fabcoin-Qt over it. (Windows)
