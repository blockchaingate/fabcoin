Fabcoin version 0.7.0 is now available for download at:
...
source-only tarballs/zipballs directly from there:
  https://github.com/blockchaingate/fabcoin/tarball/v0.7.0  # .tar.gz
  https://github.com/blockchaingate/fabcoin/zipball/v0.7.0  # .zip
