Fabcoin Core version 0.9.4 is now available from:

  https://fabcoin.org/bin/0.9.4/
...
this update is incompatible with the Fabcoin system and could lead to consensus
forks.

Fabcoin Core released binaries from https://fabcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~fabcoin/+archive/ubuntu/fabcoin
- A third-party or self-compiled Fabcoin Core

upgrade to Fabcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
