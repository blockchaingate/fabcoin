Fabcoin Core version 0.12.0 is now available from:
  ...
  <https://fabcoin.org/bin/fabcoin-core-0.12.0/>
...
[libsecp256k1](https://github.com/fabcoin-core/secp256k1) instead of OpenSSL.
...
(https://github.com/fabcoin/bips/blob/master/bip-0130.mediawiki)
...
(https://github.com/fabcoin/bips/blob/master/bip-0125.mediawiki).
...
notes of v0.11.0](https://github.com/blockchaingate/fabcoin/blob/v0.11.0/doc/release-notes.md#block-file-pruning).

`NODE_BLOOM` service bit
------------------------

Support for the `NODE_BLOOM` service bit, as described in [BIP
111](https://github.com/fabcoin/bips/blob/master/bip-0111.mediawiki), has been
...
* OP_NOP2 has been renamed to OP_CHECKLOCKTIMEVERIFY by [BIP 65](https://github.com/fabcoin/bips/blob/master/bip-0065.mediawiki)
