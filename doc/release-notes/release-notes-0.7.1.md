Fabcoin version 0.7.1 is now available from:
...
source-only tarballs/zipballs directly from there:
  https://github.com/blockchaingate/fabcoin/tarball/v0.7.1  # .tar.gz
  https://github.com/blockchaingate/fabcoin/zipball/v0.7.1  # .zip
