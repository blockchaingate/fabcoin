Fabcoin Core version 0.14.0 is now available from:
  ...
  <https://fabcoin.org/bin/fabcoin-core-0.14.0/>
...
now ZMQ can be used on Windows. Please see [this document](https://github.com/blockchaingate/fabcoin/blob/master/doc/zmq.md) for
...
The Alert System was [disabled and deprecated](https://fabcoin.org/en/alert/2016-11-01-alert-retirement) in Fabcoin Core 0.12.1 and removed in 0.13.0. 
...
----------------------
 ...
 - A new RPC command `getmemoryinfo` has been added which will return information
   ...
   optimizations to memory management. See [Pull #8753](https://github.com/blockchaingate/fabcoin/pull/8753)
