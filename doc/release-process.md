...
space *do not upload these to the  https://fabcoin.pro server, nor put them in the torrent*.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the  https://fabcoin.pro server
