...
This document provides guidelines for internationalization of the Fabcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `fabcoin_en.ts` remains unchanged.
