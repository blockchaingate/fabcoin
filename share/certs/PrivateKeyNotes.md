...
unlocked to sign the Fabcoin-Qt.app bundle.
...
allowing somebody to distribute a Fabcoin-Qt.app or fabcoin-qt-setup.exe with a valid
...
that the fabcoin-qt.exe file inside the installer had not been tampered with.
