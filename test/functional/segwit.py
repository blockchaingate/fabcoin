...
class SegWitTest(FabcoinTestFramework):
    ...
    def run_test(self):
        ...
        txid1 = send_to_witness(1, self.nodes[0], find_unspent(self.nodes[0], 25), self.pubkey[0], False, Decimal("24.996"))
        ...
        tx.vout.append(CTxOut(int(24.99*COIN), CScript([OP_TRUE])))
        ...
        tx.vout.append(CTxOut(int(24.95*COIN), CScript([OP_TRUE]))) # Huge fee
        tx.calc_sha256()
