...
class TxnMallTest(FabcoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 25 block's reward FAB:
        ...
        assert_equal(self.nodes[0].getbalance(""),
                     starting_balance + ICO_BLOCK_REWARD - 309 - 29 + fund_foo_tx["fee"] + fund_bar_tx["fee"])
        ...
        assert_equal(self.nodes[0].getbalance("", 0), starting_balance + ICO_BLOCK_REWARD
                                                                - 309
                                                                + fund_foo_tx["fee"]
                                                                -   29
                                                                + fund_bar_tx["fee"]
